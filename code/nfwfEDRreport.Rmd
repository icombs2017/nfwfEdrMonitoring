...
twelveMonthACERtab <- twelveMonthACERtab1 %>% 
  ...
  add_footer_row(values = 
    list(
      ...
      "",
      "",
      `12-month Survival` = round(mean(twelveMonthACERtab1$`12-month Survival`), 2),
      `12-month % Dead` = round(mean(twelveMonthACERtab1$`12-month % Dead`), 2),
      `12-month % Missing` = round(mean(twelveMonthACERtab1$`12-month % Missing`), 2),
      `12-month % Plot Survival` = round(mean(twelveMonthACERtab1$`12-month % Plot Survival`),2)),
    colwidths = c(1, 1, 1, 1, 1, 1, 1))
