...
# Making a column for Species using the length of each character in our Site Column. Note: we are doing this here before we turn that colum into a factor below.
