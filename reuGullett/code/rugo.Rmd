...
set.seed(09081992)
rugoPerm <- adonis2(rugoRMS$sd ~ time*treat, data = rugoRMS, permutations = 9999, method = 'bray')

rugoPerm


 
rugoPairwise <- pairwise.adonis(x = rugoRMS$sd, factors = rugo$treat, perm = 9999, sim.method = 'bray', correcti)
...
myColors <- c("#4a83c4", "#badef5", "purple")
